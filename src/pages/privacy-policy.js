...
const PrivacyPolicyPage = () => (
  ...
  <TextContent>
    ...
    <section>
      <h3>Zugriffsdaten</h3>
      <p>
        Wir, der Websitebetreiber, erheben selbst keine personenbezogenen Daten.
        Sie können diese Webseite nutzen, ohne personenbezogene Daten an den
        Webseitenbetreiber herauszugeben.
      </p>
      <p>
        Zum Hosting der Webseite verwenden wir GitHub Pages. Durch den Besuch
        auf dieser Webseite erhebt GitHub personenbezogene Daten (z.B. in Form
        von sog. Server Log Dateien). Diese Daten beinhalten die besuchte
        Website, Uhrzeit zum Zeitpunkt des Zugriffes, Menge der gesendeten Daten
        in Byte, Quelle/Verweis von welchem Sie auf diese Seite gelangten,
        verwendeter Browser, verwendetes Betriebssystem und verwendete
        IP-Adresse.
        <br />
        GitHub benötigt diese Daten, um die Funktionsfähigkeit und Sicherheit
        der Webseite gewährleisten zu können. Bitte konsultieren Sie{" "}
    ...
    <section>
      ...
      <p>
        ...
        werden können - also beispielsweise Ihre E-Mail-Adresse und
        Telefonnummer.
      </p>
      <p>
      ...
      <p>
        Nehmen Sie mit mir als Websitebetreiber per Email eine Verbindung auf,
        wird Ihre Email Adresse gespeichert, um Ihre Anfrage beantworten zu
        können. Ohne Ihre Einwilligung werden diese Daten nicht an Dritte
        weitergegeben. Die personenbezogenen Daten, welche durch das Senden
        einer Email erhoben wurden, werden nach Erledigung der von Ihnen
    ...
    <section>
      ...
      <p>
        ...
        Verschlüsselung geschützt. Dabei kommt das TLS Verfahren zum Einsatz.
        Dass eine angefragte Seite verschlüsselt übertragen wird, erkennen Sie
        daran, dass in der Adresszeile des Browsers das Protokoll "https"
        verwendet wird und ein grünes Schloss-Symbol neben der Adresszeile zu
        sehen ist.
      </p>
      <p>
        Bitte bedenken Sie, dass keine Internetübertragung absolute Sicherheit
        garantiert oder fehlerfrei ist. Sie werden darauf hingewiesen, dass
        standard E-Mails auf dem Übertragungsweg unbefugt und unbemerkt
    ...
    <section>
      ...
      <p>
        ...
        sich bitte an mich unter Verwendung der oben stehenden
