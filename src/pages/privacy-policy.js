      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <p>
            ...
            Daten. Sie können diese Webseite nutzen, ohne personenbezogene Daten
            an den Webseitenbetreiber herauszugeben.
          </p>
          <p>
            ...
            die besuchte Website, Uhrzeit zum Zeitpunkt des Zugriffes, Menge der
            gesendeten Daten in Byte, Quelle/Verweis von welchem Sie auf diese
            Seite gelangten, verwendeter Browser, verwendetes Betriebssystem und
            verwendete IP-Adresse.
            <br />
            GitHub benötigt diese Daten, um die Funktionsfähigkeit und
            Sicherheit der Webseite gewährleisten zu können. Bitte konsultieren
            Sie{" "}
        ...
        <div className="content">
          ...
          <p>
            ...
            durch das Senden einer Email erhoben wurden, werden nach Erledigung
        ...
        <div className="content">
          ...
          <p>
            ...
            Protokoll "https" verwendet wird und ein grünes Schloss-Symbol neben
            der Adresszeile zu sehen ist.
          </p>
          <p>
            Bitte bedenken Sie, dass keine Internetübertragung absolute
            Sicherheit garantiert oder fehlerfrei ist. Sie werden darauf
            hingewiesen, dass standard E-Mails auf dem Übertragungsweg unbefugt
            und unbemerkt mitgelesen oder verändert werden können.
          </p>
        </div>
        <div className="content">
